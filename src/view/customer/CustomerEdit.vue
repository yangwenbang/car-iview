  ...
  <div class="white-bg">
    ...
    <div class="compony-type" v-show="formValidate.companyType==0">
      <Form :label-width="200" class="search-form" ref="formValidate" :model="formValidate" :rules="ruleValidate">
        ...
        <Row type="flex" justify="space-between">
          ...
          <FormItem label="协议起止时间:">
            <DatePicker v-model="formValidate.protocolStartDate" type="daterange" placement="bottom-end"></DatePicker>
          </FormItem>
          </Col>
          <Col :sm="12" :xs="24">
          <FormItem label="公司成立日期:">
            <DatePicker v-model="formValidate.foundDate" type="date" separator="/" placement="bottom-end"></DatePicker>
          </FormItem>
          </Col>
          <Col :sm="12" :xs="24">
        ...
        <Row type="flex" justify="space-between">
          <Col :sm="12" :xs="24">
          <FormItem label="开户银行:">
            <Select v-model="formValidate.openBank" filterable clearable remote :remote-method="getBankList" @on-clear="getBankList('')">
              <Option v-for="(item,index) in openBankList" :value="item.bankName" :key="index">{{ item.bankName }}</Option>
            </Select>
          </FormItem>
          </Col>
          <Col :sm="12" :xs="24">
          ...
          <FormItem label="纳税人类型:">
            <Select v-model="formValidate.taxPayType" filterable clearable>
              <Option v-for="(item,index) in taxPayTypeList" :value="item.value" :key="index">{{ item.label }}</Option>
            </Select>
          </FormItem>
          </Col>
          <Col :sm="12" :xs="24">
        ...
        <Row type="flex" justify="space-between">
          ...
          <FormItem label="联系人座机:">
            <Row type="flex" justify="space-between" flex-der>
              <Col :sm="7" :xs="24">
              <Input placeholder="区号" v-model="formValidate.contractCallAreaNumber" :maxlength="10"></Input>
              </Col>-
              <Col :sm="7" :xs="24">
              <Input placeholder="座机号" v-model="formValidate.contractCallNumber" :maxlength="10"></Input>
              </Col>-
              <Col :sm="7" :xs="24">
          ...
          <FormItem label="财务联系人座机:">
            <Row type="flex" justify="space-between" flex-der>
              <Col :sm="7" :xs="24">
              <Input placeholder="区号" v-model="formValidate.financeContractCallAreaNumber" :maxlength="10"></Input>
              </Col>-
              <Col :sm="7" :xs="24">
              <Input placeholder="座机号" v-model="formValidate.financeContractCallNumber" :maxlength="10"></Input>
              </Col>-
              <Col :sm="7" :xs="24">
              <Input placeholder="短号" v-model="formValidate.financeContractCornette" :maxlength="10"></Input>
              </Col>
            </Row>
          </FormItem>
          </Col>
          ...
          <Row>
            ...
            <div class="clearfix">
              ...
              <div v-show="uploadList.length<1">
                ...
                <Upload ref="upload" :show-upload-list="false" :default-file-list="defaultList" :on-success="handleSuccess" name="files" accept=".jpg,.jpeg,.png" :format="['jpg','jpeg','png']" :max-size="5120" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :before-upload="handleBeforeUpload" type="drag" action="/api/pwms/customer/uploadFiles" style="display: inline-block;width:118px;">
          ...
          <Row>
            ...
            <div class="clearfix">
              ...
              <div class="pull-left margin-left-10" v-show="uploadList1.length<1">
                ...
                <Upload ref="upload1" :default-file-list="defaultList1" :show-upload-list="false" :on-success="handleSuccess" name="files" accept=".jpg,.jpeg,.png" :format="['jpg','jpeg','png']" :max-size="5120" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" type="drag" action="/api/pwms/customer/uploadFiles" style="display: inline-block;width:118px;">
                  <div style="width: 118px;height:118px;line-height: 118px;">
                    <Icon type="ios-camera" size="20"></Icon>
                  </div>
                </Upload>
              ...
              <div class="pull-left margin-left-10" v-show="uploadList2.length<1">
                ...
                <Upload ref="upload2" :default-file-list="defaultList2" :show-upload-list="false" :on-success="handleSuccess" name="files" accept=".jpg,.jpeg,.png" :format="['jpg','jpeg','png']" :max-size="5120" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" type="drag" action="/api/pwms/customer/uploadFiles" style="display: inline-block;width:118px;">
                  <div style="width: 118px;height:118px;line-height: 118px;">
                    <Icon type="ios-camera" size="20"></Icon>
                  </div>
                </Upload>
              ...
              <div class="pull-left margin-left-10" v-show="uploadList3.length<1">
                ...
                <Upload ref="upload3" :default-file-list="defaultList3" :show-upload-list="false" :on-success="handleSuccess" name="files" accept=".jpg,.jpeg,.png" :format="['jpg','jpeg','png']" :max-size="5120" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" type="drag" action="/api/pwms/customer/uploadFiles" style="display: inline-block;width:118px;">
                  <div style="width: 118px;height:118px;line-height: 118px;">
                    <Icon type="ios-camera" size="20"></Icon>
                  </div>
                </Upload>
      ...
      <div class="text-center margin-top-10">
        <Button type="primary" class="btn-common-width" @click="handleSubmit('formValidate')" :disabled="submitDisabled">保存</Button>
    ...
    <div class="personal-type" v-show="personformValidate.userType==1">
      <Form :label-width="200" class="search-form" ref="personformValidate" :model="personformValidate" :rules="personruleValidate">
        ...
        <Row type="flex" justify="space-between">
          ...
          <Col :sm="12" :xs="24">
          <FormItem label="协议起止时间:">
            <DatePicker v-model="personformValidate.protocolStartDate1" type="daterange" placement="bottom-end"></DatePicker>
          </FormItem>
          </Col>
          <Col :sm="12" :xs="24">
            <FormItem label="是否允许月结:" prop="isMonthSettle">
        ...
        <div class="text-center margin-top-10">
          <Button type="primary" class="btn-common-width" @click="handleSubmit('personformValidate')" :disabled="submitDisabled">保存</Button>
          <Button class="btn-common-width margin-left-10" @click="backFun">取消</Button>
        </div>
      </Form>
    </div>
  ...
  methods: {
    ...
    getInfor() {
      showCustomer({
        ...
        if (data.code == "200") {
          let data1 = data.data;
          if (data1.companyType == 0) {
            this.formValidate.companyType = "0";
            this.personformValidate.userType = "0";
            this.companyInfor(data1);
          } else {
            this.formValidate.companyType = "1";
            this.personformValidate.userType = "1";
            this.personalInfor(data1);
          }
        } else {
          this.$Message.error(res.data.msg);
        }
    ...
    companyInfor(data) {
      if (data.businessLicense) {
        this.defaultList = [
          {
            name: "",
            url: "//mfs.banksteel.com/" + data.businessLicense,
            response: {
              code: "200",
      ...
      const threeLicense3 = data.threeLicense
        ? data.threeLicense.split(",")
        : [];
        ...
        let arr = [
          {
            ...
            response: {
              code: "200",
              data: threeLicense3[i]
            },
            desc: ""
          }
        ];
        if (i == 0) {
          this.defaultList1 = arr;
        } else if (i == 1) {
          this.defaultList2 = arr;
        } else if (i == 2) {
          this.defaultList3 = arr;
        }
      }
      this.$nextTick(() => {
        this.uploadList = this.$refs.upload.fileList;
        if (this.$refs.upload1.fileList.length > 0) {
          this.$refs.upload1.fileList[0].uid =
            this.$refs.upload1.fileList[0].uid + "1";
        }
        if (this.$refs.upload2.fileList.length > 0) {
          this.$refs.upload2.fileList[0].uid =
            this.$refs.upload2.fileList[0].uid + "2";
        }
        if (this.$refs.upload3.fileList.length > 0) {
          this.$refs.upload3.fileList[0].uid =
            this.$refs.upload3.fileList[0].uid + "3";
        }
      ...
      this.formValidate = {
        ...
        customerContractId: data.customerContracts
          ? data.customerContracts[0].customerContractId
          : "",
        customerName: data.customerName,
        customerShortName: data.customerShortName,
        creditCode: data.creditCode,
        foundDate: data.foundDate ? new Date(data.foundDate) : "", //公司成立日期
        registLocal: [
        ...
        registerAddress: data.registerAddress, //公司注册详细地址
        local: [data.province, data.city, data.area], //公司地址
        protocolStartDate: [
          data.protocolStartDate ? new Date(data.protocolStartDate) : "",
          data.protocolEndDate ? new Date(data.protocolEndDate) : ""
        ], //协议起止时间
        address: data.address, //公司详细地址
        phone: data.phone, //公司电话
        fax: data.fax, //公司传真
        companyType: "0", //客户类型
        openBank: data.openBank, //开户银行
        openBankAddress: [
          data.openBankProvince,
          data.openBankCity,
          data.openBankArea
        ], //开户行所在地
        openBankPoint: data.openBankPoint, //开户行网点名称
        openBankAccount: data.openBankAccount, //银行账号
        taxPayType: data.taxPayType.toString(), //纳税人类型
        taxPayNumber: data.taxPayNumber, //纳税人识别号
        ticketAddress: [
          data.invocieProvince,
          data.invocieCity,
          data.invocieArea
        ], //开票地址
        invocieAddress: data.invocieAddress, //开票详细地址
        corporate: data.corporate, //法人姓名
        corporateCard: data.corporateCard, //法人身份证号码
        corporatePhone: data.corporatePhone, //法人联系电话
        contract: data.customerContracts
          ? data.customerContracts[0].contract
          : "", //业务联系人
        contractPhone: data.customerContracts
          ? data.customerContracts[0].contractPhone
          : "", //业务联系人手机
        contractCallAreaNumber: data.customerContracts
          ? data.customerContracts[0].contractCallAreaNumber
          : "", //业务联系人座机区号
        contractCallNumber: data.customerContracts
          ? data.customerContracts[0].contractCallNumber
          : "", //业务联系人座机号
        contractCornette: data.customerContracts
          ? data.customerContracts[0].contractCornette
          : "", //业务联系人短号
        contractQQ: data.customerContracts
          ? data.customerContracts[0].contractQQ
          : "", //联系人QQ
        financeContract: data.customerContracts
          ? data.customerContracts[0].financeContract
          : "", //财务联系人
        financeContractPhone: data.customerContracts
          ? data.customerContracts[0].financeContractPhone
          : "", //财务联系人手机
        financeContractCallAreaNumber: data.customerContracts
          ? data.customerContracts[0].financeContractCallAreaNumber
          : "", //财务联系人座机区号
        financeContractCallNumber: data.customerContracts
          ? data.customerContracts[0].financeContractCallNumber
          : "", //财务联系人座机号
        financeContractCornette: data.customerContracts
          ? data.customerContracts[0].financeContractCornette
          : "", //财务联系人短号
        financeContractQQ: data.customerContracts
          ? data.customerContracts[0].financeContractQQ
          : "", //财务联系人QQ
        sendAddress: [
          data.invocieSendProvince,
          data.invocieSendCity,
          data.invocieSendArea
        ], //发票邮寄地址
        invocieSendAddress: data.invocieSendAddress, //发票邮寄详细地址
        isMonthSettle: data.isMonthSettle
      };
    },
    personalInfor(data) {
      this.personformValidate = {
        //个人类型
        userType: "1",
        companyType: "1", //客户类型
        customerId: data.customerId,
        ...
        corporateCard: data.corporateCard, //身份证号码
        phone: data.customerContracts
          ? data.customerContracts[0].contractPhone
          : "", //手机号
        contractCallAreaNumber: data.customerContracts
          ? data.customerContracts[0].contractCallAreaNumber
    ...
    submitFun1() {
      ...
      updateCustomer({
        ...
        customerContractId: this.formValidate.customerContractId,
    ...
    submitFun2() {
      ...
      this.personformValidate.protocolEndDate =
        ...
        this.personformValidate.protocolStartDate1[1]
          ...
          : "";
      updatePersonal(this.personformValidate).then(res => {
        if (res.data.code == "200") {
          this.$Message.success({
            content: "保存成功!",
            duration: 1
