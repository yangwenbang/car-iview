<template>
    <div class="white-bg">
        ...
        <!-- <Row class="margin-top-20 margin-bottom-10">
            <Col span="24">
            <div class="pull-left table-title">审核结果</div>
            </Col>
        </Row>
        <Form :label-width="150" class="search-form">
            <Row type="flex" justify="space-between">
                <Col :sm="24" :xs="24">
                <FormItem label="客户审核结论：">
                    <RadioGroup v-model="params.result">
                        <Radio label="审核通过" size="large" class="margin-right-20"></Radio>
                        <Radio label="审核拒绝" size="large"></Radio>
                    </RadioGroup>
                </FormItem>
                </Col>
                <Col :sm="24" :xs="24">
                <FormItem label="审核说明：">
                    <Input v-model="params.desc" type="textarea" placeholder="" />
                </FormItem>
                </Col>
            </Row>
        </Form> -->
        <div class="text-center margin-top-20">
            <Button type="primary" class="btn-common-width" @click="submitFun">审核</Button>
...
import { showCustomer, auditCustomer } from "@/api/customer";
export default {
  name: "CustomerAudit",
  data() {
    return {
