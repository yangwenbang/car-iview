        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
          ...
          <tbody>
            <tr v-for="(trItem,index) in tableData" :key="index" @keyup="keyCopyFun($event,index)">
              ...
              <td>
                <div class="ivu-table-cell">
                  <InputNumber :class="tableData[index].number.status || tableData[index].number.value ? '' : 'error'" :parser="inputDecimal1" style="width:100%;" :maxlength="8" :min="1" v-model="tableData[index].number.value" @on-change="countTonage(index)" />
                </div>
              </td>
              <td>
