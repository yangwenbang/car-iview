    ...
    <div class="white-bg audit-oss">
        ...
        <Table :columns="tableColumns" :data="tableData" border>
            <div slot="footer" class="table-foot">
                <div class="other-price-info" v-if="settleTimeType==0">
									<Row>
											<Col :sm="8" :xs="24">
        ...
        <div class="text-center margin-top-20">
            <Button type="primary" @click="submitFun">审核通过</Button>
...
import { formatPrice, formatWeight, closeNowTag } from "@/libs/util";
export default {
    ...
    getList() {
      OutSettleDetail({
        ...
        if (res.data.code == "200") {
          ...
          this.settleTimeType=this.formParams.settleTimeType;
...
//     $route(to, from) {
//       //重新获取数据
//       if (to.name == "AuditOutstockSettlement") {
//         this.getList();
//       }
//     }
//   }
...
<style scoped>
.audit-oss >>> .ivu-table-footer{
	height: 0px !important;
	line-height: 0px !important;
}
.audit-oss  .other-price-info{
	height: 48px ;
	line-height: 48px ;
}
</style>
