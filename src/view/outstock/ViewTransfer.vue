<template>
    <div class="white-bg">
        ...
        <div class="text-center margin-top-20">
            <Button v-if="transferData.status != 9" class="btn-common-width margin-right-10" type="primary" @click="print">打印</Button>
            <Button class="btn-common-width margin-right-10" @click="cancel">关闭</Button>
        </div>
    </div>
</template>
<script>
import { closeNowTag, formatPrice,formatWeight, isAcrobatPluginInstall } from "@/libs/util";
...
export default {
    ...
    methods: {
        ...
        print() {
            ...
            if(result){
                window.open('/api/pwms/inventory/transfer/printTransferOrder?transferId=' + this.transferId)
            } 
        },
        cancel() {
